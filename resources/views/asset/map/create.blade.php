    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">{{ __('Paparan Asas') }}
                        <div class="dropdown">
                    ...
                    <div class="card-body">
                        <form action="{{ route('map.store', $asset->id) }}" method="POST">
                            @csrf
                          <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="lat" id="latitude" class="form-control" placeholder="Latitude"/>
                                        <input type="text" name="lng" id="longitude" class="form-control" placeholder="Longitude"/>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
       var map;
            var marker;
            var myLatlng = new google.maps.LatLng(3.1550939576315487, 101.68861360170186);
